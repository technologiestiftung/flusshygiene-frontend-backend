...
export const Head = (props: IHead) => (
  <head>
    ...
    <meta
      name='description'
      content='Aktuelle Badegewässerqualität und Informationen rund um die Berliner Badestellen'
    />
    <link
      rel='apple-touch-icon'
      sizes='128x128'
      href='/assets/images/android-chrome-128x128.png'
    />
    <link
      rel='apple-touch-icon'
      sizes='180x180'
    ...
    <link
      ...
      type='image/png'
      sizes='256x256'
      href='/assets/images/android-chrome-256x256.png'
    />
    <link
      rel='icon'
      type='image/png'

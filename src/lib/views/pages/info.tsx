...
const info = (props: IViewProps) => {
  return (
    <Skeleton title={'Vorhersagemodell'} isLoggedin={props.isLoggedin}>
      <div className='info'>
        ...
        {/* tslint:disable-next-line: max-line-length */}
        <p>
          Einige Badestellen im nördlichen Bereich der Unterhavel (Grunewaldturm
          und Kleine Badewiese) werden, wenn es regnet, vom Berliner Stadtgebiet
          beeinflusst. Wie wir es von der Wettervorhersage kennen, regnet es
          örtlich und zeitlich sehr unterschiedlich. Auch die
          Fließgeschwindigkeit in Spree und Havel kann sich innerhalb kurzer
          Zeit stark verändern. Mit einer Verschlechterung der
          Badegewässerqualität ist dann zu rechnen, wenn es stark geregnet hat,
          es zu Einleitungen aus dem Stadtgebiet kommt, und die
          Fließgeschwindigkeit im Fluss hoch ist. Dieser Zusammenhang wurde im
          Forschungsprojekt FLUSSHYGIENE über zwei Jahre sehr genau untersucht
          und kann nun genutzt werden um die Badegewässerqualität vorherzusagen.
        </p>
        {/* tslint:disable-next-line: max-line-length */}
        <p>
